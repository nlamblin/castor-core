...
function Compute(schema, options) {
  ...
  self.coll1 = pmongo(self.options.connectionURI).collection(self.options.collectionName);
  self.coll2 = pmongo(self.options.connectionURI).collection(self.options.collectionName + '_corpus');
  self.schema = schema;
  self.bank = {};
